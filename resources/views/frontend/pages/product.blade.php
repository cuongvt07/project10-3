                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                        <div class="ht__product__dtl">
                            <h1 class="product-title product_title entry-title" style="font-family: 'sans-serif', sans-serif;font-style: normal;font-weight: 700;text-decoration: none;text-transform: none;">{{$data->product_name}}</h1>
                            <hr>
                            <div class="woocommerce-product-rating woocustom_single_rating">
                                ...
                                <div class="sin__desc align--left">
                                    <p><span>Khối lượng:</span></p>
                                    <ul class="pro__cat__list">
                                        <li><a href="/shop/brand/{{$data->brand_id}}">{{$data->brand->brand_name}}</a></li>
                                    </ul>
                                </div>
                                <div class="inve_brand mt-1">
                                    <span class="stock-brand-title"><strong><i class="ion ion-ios-checkmark-circle"></i> Quy cách đóng gói:</strong></span>
                                    <span class="a-brand">Hộp</span>
                                </div>
                            </div>
                            <hr>
                            <div class="inventory_quantity bizweb deny 5">
                                ...
                                @if ($data->product_amount != 0)
                                    <span class="a-stock a0" style="color: #30a43b;">Còn hàng</span>
                                @else
